...
//It is currently distributed with this intent only.  Other uses should be with permission and due citation.  For more information, contact ryan@gshed.com
//=====================================================================================================================================
//=====================================================================================================================================
...
class Pose {
  ...
  void fromPoints(PVector origin, PVector xPt, PVector yPt) {
    ...
    PVector xAxis = PVector.sub(xPt, origin).normalize(); //our x axis is defined by the line between //this line has problems in processing 2.2.1      
